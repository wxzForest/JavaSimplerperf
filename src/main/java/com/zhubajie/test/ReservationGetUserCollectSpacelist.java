...
public class ReservationGetUserCollectSpacelist  extends AbstractJavaSamplerClient {
    ...
    public Arguments getDefaultParameters() {
        ...
        params.addArgument("url","http://49.4.69.48/zwork/getUserBespeakSpaceList");
        ...
        params.addArgument("SpaceIds","1322,1307,1286");
        return params;
    }
    ...
    public static void main(String[] args) {
        ReservationGetUserCollectSpacelist op=new ReservationGetUserCollectSpacelist();
