...
public class SpaceListByTags extends AbstractJavaSamplerClient {
    ...
    public Arguments getDefaultParameters() {
        ...
        params.addArgument("UserId","5315");
        params.addArgument("SubUserId","5315");
        params.addArgument("SpaceIds","5315");
        return params;
    }
    ...
    public static void main(String[] args) {
        SpaceListByTags op=new SpaceListByTags();
