 ...
 */
public class Test_TaskService_getTask extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        sr.setSampleLabel("Test_TaskService_getTask");
        try {
            ...
            Result<TaskDO> result = taskService.getTask(request);
